...
_TOPIC_CLOSERS = (
    "不说了", "就这样", "算了", "没事", "先这样", "不聊这个", "跳过", "换个话题",
)
...
def topic_hint(text: str) -> str:
    ...
    if any(w in text for w in ("谢谢", "谢谢你", "辛苦", "感谢")):
        return "对方在向你道谢，自然回应一句就好，慵懒温柔，不必太隆重。"
    if any(w in text for w in ("你还好吗", "你没事吧", "累不累", "想你了", "在吗", "在不在", "想我没", "在干嘛", "忙吗")):
        return "对方在关心你/想你了/找你，重点放在回应这份牵挂上，温柔黏人一点，别跑题。"
    if text.endswith(("吗", "么", "没", "呢", "呀")) and any(w in text for w in ("？", "?", "什么", "怎么", "为啥", "为什么", "呢", "吗")):
